package com.app.ricktech.uis.separate_pc_module.activity_separate_pc_sub_building;
...
public class SeparatePcSubBuildingActivity extends AppCompatActivity {
    ...
    private void getSubBuildings() {
        Api.getService(Tags.base_url)
                .getSeparateSubCategoryBuilding(lang, parentModel.getId() + "",brand_id)
