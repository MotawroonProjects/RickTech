package com.app.ricktech.uis.separate_laptop_gaming_module.activity_separate_laptop_gaming_sub_building;
...
import com.app.ricktech.databinding.ActivitySeparatePcSubBuildingBinding;
...
public class SeparateLaptopGamingSubBuildingActivity extends AppCompatActivity {

    private ActivitySeparatePcSubBuildingBinding binding;
    private String lang;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_separate_pc_sub_building);
        getDataFromIntent();
        initView();
    }
    ...
    private void getDataFromIntent() {
        ...
        brand_id = intent.getStringExtra("data2");
    ...
    private void getSubBuildings() {
        Api.getService(Tags.base_url)
                .getSeparateLaptopGamingSubCategoryBuilding(lang, parentModel.getId() + "",brand_id)
