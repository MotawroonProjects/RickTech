package com.app.ricktech.uis.separate_gaming_module.activity_separate_gaming_sub_building;
...
public class SeparateGamingSubBuildingActivity extends AppCompatActivity {
    ...
    private void getSubBuildings() {
        Api.getService(Tags.base_url)
                .getSeparateGamingSubCategoryBuilding(lang, parentModel.getId() + "",brand_id)
